...
The official source code for IR-Agent: Expert-Inspired LLM Agents for Structure Elucidation from Infrared Spectra, accepted at ICLR 2026 main conference.
### Overview
...
![Overall Framework of IR-Agent](./dataset_utils/model_architecture_png.png)  
